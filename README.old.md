...
Ubuntu 22.04/24.04 上可以直接使用根目录新增的两个脚本：
...
- `build.sh` 会自动构建 Vue 前端、复制嵌入资源，并编译出 Linux 二进制 `./personnel-management`
- `run.sh` 会自动选择可用端口，默认从 `8080` 开始尝试
- 默认数据库位置是 `./data/personnel.db`
